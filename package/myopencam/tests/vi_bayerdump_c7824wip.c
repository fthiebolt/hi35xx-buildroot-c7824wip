...
/* Francois apr.19 */
#define SIMPLE_BAYER_DUMP   1       // just to run RAW Bayer dump
...
#define DEV_ATTR           DEV_ATTR_GC1004_DC_720P_BASE // 10 bits ADC
...
#define DEV_ATTR           DEV_ATTR_AR0130_DC_720P_BASE     // through ISP
#define DEV_BAYER_ATTR     stBayerAr0130Attr                // ISP bypass
#define CHN_BAYER_ATTR     stBayerChn720PAttr
#endif
...
#endif
#if defined SNS_GC1004 || defined SNS_GC1014 || defined SNS_GC1024
    /* GalaxyCore CMOS sensor in Windowed mode ?? */
#endif
...
/* Francois apr.19 */
#ifndef SIMPLE_BAYER_DUMP

    /* start of ISP processing bayer data */
    ...
    /* Start of raw bayer (i.e ISP bypass) */
